...
package com.xxun.xunlauncher.nvram;
...
public interface NvRAMAgent extends android.os.IInterface {
	...
	public static abstract class Stub extends android.os.Binder implements
		...
		/**
		 * Cast an IBinder object into an NvRAMAgent interface, generating a
		 * proxy if needed.
		 */
		...
		private static class Proxy implements NvRAMAgent {
			...
			public byte[] readFile(int file_lid)
					throws android.os.RemoteException {
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_READFILE, _data, _reply,
							0);
			...
			public int writeFile(int file_lid, byte[] buff)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				int _result;
				try {
					...
					mRemote.transact(Stub.TRANSACTION_WRITEFILE, _data, _reply,
							0);
					_reply.readException();
