 ...
 */
public class EarthTwo extends BaseWatchView {
    ...
    private static final String TAG = "EarthTwo";

    public EarthTwo(Context context) {
        this(context,null);
    }

    public EarthTwo(Context context, AttributeSet attrs) {
        this(context,attrs,0);
    }

    public EarthTwo(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        numberResources = new int[10];
        weekDays = new String[7];
        initDatas();
        initView(LayoutInflater.from(context).inflate(R.layout.earth_two, this, true));
    }

    protected void initDatas() {
        numberResources = new int[]{
                R.drawable.huoxing0,R.drawable.huoxing1,R.drawable.huoxing2,R.drawable.huoxing3,R.drawable.huoxing4,R.drawable.huoxing5,R.drawable.huoxing6,
                R.drawable.huoxing7,R.drawable.huoxing8,R.drawable.huoxing9};
