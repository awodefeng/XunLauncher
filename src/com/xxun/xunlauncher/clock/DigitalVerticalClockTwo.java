...
public class DigitalVerticalClockTwo extends BaseWatchView {
    ...
    public DigitalVerticalClockTwo(Context context) {
        this(context,null);
    }

    public DigitalVerticalClockTwo(Context context, AttributeSet attrs) {
        this(context,attrs,0);
    }

    public DigitalVerticalClockTwo(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initDatas() {
        hourResources = new int[]{
           R.drawable.digital_hor_h_0,R.drawable.digital_hor_h_1,R.drawable.digital_hor_h_2,R.drawable.digital_hor_h_3,R.drawable.digital_hor_h_4,R.drawable.digital_hor_h_5,R.drawable.digital_hor_h_6,
                R.drawable.digital_hor_h_7,R.drawable.digital_hor_h_8,R.drawable.digital_hor_h_9};
        minuteResources = new int[]{
                R.drawable.digit_hor_m_0,R.drawable.digit_hor_m_1,R.drawable.digit_hor_m_2,R.drawable.digit_hor_m_3,R.drawable.digit_hor_m_4,R.drawable.digit_hor_m_5,R.drawable.digit_hor_m_6,
                R.drawable.digit_hor_m_7,R.drawable.digit_hor_m_8,R.drawable.digit_hor_m_9};
