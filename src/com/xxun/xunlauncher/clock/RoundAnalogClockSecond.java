 ...
 */
public class RoundAnalogClockSecond extends BaseWatchView {
    ...
    public RoundAnalogClockSecond(Context context) {
        this(context,null);
    }

    public RoundAnalogClockSecond(Context context, AttributeSet attrs) {
        this(context,attrs,0);
    }

    public RoundAnalogClockSecond(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initView(LayoutInflater.from(context).inflate(R.layout.round_clock_02, this, true));
    }
