 ...
 */
public class DigitalOfflineDefaultClock extends BaseWatchView {
    ...
    private static final String TAG = "DigitalOfflineDefaultClock";

    public DigitalOfflineDefaultClock(Context context) {
        this(context,null);
    }

    public DigitalOfflineDefaultClock(Context context, AttributeSet attrs) {
        this(context,attrs,0);
    }

    public DigitalOfflineDefaultClock(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        numberResources = new int[10];
        weekDays = new String[7];
        initDatas();
        initView(LayoutInflater.from(context).inflate(R.layout.digital_offline_clock, this, true));
    }

    protected void initDatas() {
        numberResources = new int[]{
                R.drawable.digit_offline_0,R.drawable.digit_offline_1,R.drawable.digit_offline_2,R.drawable.digit_offline_3,R.drawable.digit_offline_4,R.drawable.digit_offline_5,R.drawable.digit_offline_6,
                R.drawable.digit_offline_7,R.drawable.digit_offline_8,R.drawable.digit_offline_9};
