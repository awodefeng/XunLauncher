...
//import android.app.usage.UsageStats;//del by lihaizhou 20180710
//import android.app.usage.UsageStatsManager;//del by lihaizhou
...
/**
 * Created by guohongcheng on 2018/3/29.
 * <p>
 * 一个工具类，可以用来判断当前栈顶的进程包名
 */
...
public class ForegroundAppUtil {
	...
	//del by lihaizhou,avoid compile error on Android 4.4,due to LOLLIPOP and UsageStats do not exist begin 20180710
	...
	//del by lihaizhou,avoid compile error on Android 4.4,due to LOLLIPOP and UsageStats do not exist end
	
	//Add by lihaizhou on 20180710
	ActivityManager manager = (ActivityManager) context.getApplicationContext().getSystemService(Context.ACTIVITY_SERVICE);
        currentClassName = manager.getRunningTasks(1).get(0).topActivity.getPackageName();
     ...
     * 获取时间段内，
     */
    //del by lihaizhou,avoid compile error on Android 4.4 20180710
